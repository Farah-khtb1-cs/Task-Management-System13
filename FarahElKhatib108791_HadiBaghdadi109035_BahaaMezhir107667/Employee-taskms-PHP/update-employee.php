                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <div id="skill-inputs">
                                  <?php 
                                  $skills = $obj_admin->get_employee_skills($admin_id);
                                  foreach($skills as $skill) { ?>
                                    <div class="skill-entry">
                                      <input type="text" value="<?php echo htmlspecialchars($skill['skill_name']); ?>" 
                                             name="skills[]" class="form-control input-custom" style="margin-bottom:5px;">
