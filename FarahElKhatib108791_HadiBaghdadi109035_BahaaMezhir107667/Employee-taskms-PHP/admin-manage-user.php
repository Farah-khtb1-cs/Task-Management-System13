                    ...
                    <div class="col-sm-6">
                      <div id="skill-inputs">
                        <div class="skill-entry">
                          <input type="text" placeholder="Skill (e.g. Python, PHP)" name="skills[]" class="form-control input-custom" style="margin-bottom:5px;">
                          <select name="proficiency[]" class="form-control input-custom" style="margin-bottom:10px;">
                      ...
                      <button type="button" class="btn btn-info btn-sm" onclick="addSkillInput()">Add Another Skill</button>
                    </div>
                  </div>
...
function addSkillInput() {
  ...
  newSkillEntry.className = 'skill-entry';
  ...
  `;
  skillInputs.appendChild(newSkillEntry);
}
</script>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <?php 
                      $skills = $obj_admin->get_employee_skills($row['user_id']);
                      foreach($skills as $skill) {
                        echo "<span class='label label-info' style='margin-right:5px;'>" 
